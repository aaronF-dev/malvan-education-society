...
const translations = {
  en: {
    ...
    'committee.member4.name': 'Mrs. Priya Desai',
    'committee.member4.position': 'Treasurer',
    'committee.member5.name': 'Prof. Mohan Kulkarni',
    'committee.member5.position': 'Academic Advisor',
